...
const addPosition = async (userRef, postion, interestedsystem) => {
  console.log(userRef.uid); //console logging, so far this is passing all the data that we have for the current user
  try {
    const test = doc(db, "users/KN0tElVPWEHPLioNKrLE"); //this works, but only for this single user as this is their autogenerated id
